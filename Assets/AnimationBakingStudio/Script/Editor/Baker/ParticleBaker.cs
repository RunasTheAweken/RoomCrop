            ...
            try
            {
                ...
                if (studio.trimming.on)
                {
                    ...
                    else
                    {
                        ...
                        tex = TextureHelper.TrimTexture(tex, texBound, studio.trimming.margin, EngineConstants.CLEAR_COLOR32);
                    }
                }
                ...
                {
                    BakeIndividually(ref tex, pivotClone, viewName, frameIndex);
                }
        ...
        public void OnEndView()
        {
            try
            {
                if (!studio.packing.on && studio.trimming.isUnifiedForAllViews)
                {
                    ...
                    BakeIndividually_Group(framePivots, viewName, frameModelTextures);
                }
