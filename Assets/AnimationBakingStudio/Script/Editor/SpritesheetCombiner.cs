...
namespace ABS
{
    public class SpritesheetCombiner
    {
        ...
        [MenuItem("Assets/" + EngineConstants.PROJECT_NAME + "/Combine Spritesheets/Only Sprite Name")]
        private static void Combine_OnlySpriteName()
        {
            Combine(true);
        }

        [MenuItem("Assets/" + EngineConstants.PROJECT_NAME + "/Combine Spritesheets/File Name + Sprite Name")]
        ...
        [MenuItem("Assets/" + EngineConstants.PROJECT_NAME + "/Combine Spritesheets/Only Sprite Name", true)]
        private static bool Validate_OnlySpriteName()
        {
            return Validate();
        }

        [MenuItem("Assets/" + EngineConstants.PROJECT_NAME + "/Combine Spritesheets/File Name + Sprite Name", true)]
