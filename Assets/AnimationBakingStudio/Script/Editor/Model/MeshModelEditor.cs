    ...
    public class MeshModelEditor : ModelEditor
    {
        ...
        private void OnInspectorGUI_Single()
        {
            ...
            if (model.IsSkinnedModel())
            {
                ...
                model.rootBone = EditorGUILayout.ObjectField(new GUIContent("Root Bone",
                    "root bone transform to fix the body in place"), model.rootBone, typeof(Transform), true) as Transform;
