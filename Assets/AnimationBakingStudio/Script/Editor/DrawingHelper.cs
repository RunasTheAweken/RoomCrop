...
namespace ABS
{
    public class DrawingHelper
    {
        ...
        {
            GUIStyle style = new GUIStyle("button");
            style.fontSize = EditorConstants.MIDDLE_BUTTON_FONT_SIZE;

            EditorGUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            bool previewUpdateClicked = GUILayout.Button(title, style, GUILayout.Width(EditorConstants.MIDDLE_BUTTON_WIDTH), GUILayout.Height(EditorConstants.MIDDLE_BUTTON_HEIGHT));
            GUILayout.FlexibleSpace();
        ...
        {
            GUIStyle style = new GUIStyle("button");
            style.fontSize = EditorConstants.WIDE_BUTTON_FONT_SIZE;
